...
import { Activity, MoveHorizontal, AlertTriangle, Globe2, Layers, Compass, Mountain, Flame, RefreshCw, CheckCircle2, ArrowRight, Bot, MapPin, Award } from 'lucide-react';
...
const IntroSection = () => (
    <div className="flex flex-col items-center justify-center h-full text-center animate-in fade-in zoom-in-95 p-4">
        <div className="relative w-64 h-64 mb-8 group">
            ...
            <Globe2 size={200} className="text-muted-foreground animate-[spin_20s_linear_infinite]" />
            <div className="absolute inset-0 flex items-center justify-center">
                 <Activity size={80} className="text-yellow-500 drop-shadow-[0_0_15px_rgba(234,179,8,0.5)] animate-pulse" />
            </div>
        </div>
        ...
        <p className="text-xl text-muted-foreground max-w-2xl leading-relaxed mb-8">
            Тобі здається, що земля під ногами нерухома? Це ілюзія. 
            Просто зараз під тобою рухаються гігантські кам'яні плити, що несуть цілі континенти.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl w-full">
            <div className="bg-popover/50 p-6 rounded-xl border border-border hover:border-yellow-500 transition-colors">
                ...
                <p className="text-sm text-muted-foreground">Тверда оболонка Землі, розбита на шматки.</p>
            </div>
            <div className="bg-popover/50 p-6 rounded-xl border border-border hover:border-yellow-500 transition-colors">
                <Mountain className="mx-auto mb-4 text-orange-500" size={32} />
                <h3 className="font-bold text-foreground mb-2">Рельєф</h3>
                <p className="text-sm text-muted-foreground">Гори ростуть саме завдяки руху плит.</p>
            </div>
            <div className="bg-popover/50 p-6 rounded-xl border border-border hover:border-yellow-500 transition-colors">
                <Activity className="mx-auto mb-4 text-red-500" size={32} />
                <h3 className="font-bold text-foreground mb-2">Землетруси</h3>
                <p className="text-sm text-muted-foreground">Що стається, коли плити зачіпають одна одну?</p>
            </div>
        </div>
    </div>
);
...
const TheoryLithosphere = () => (
    <div className="flex flex-col md:flex-row gap-8 h-full animate-in fade-in items-center">
        <div className="flex-1 space-y-6">
            <h2 className="text-4xl font-display font-bold text-foreground">Земля як Пазл</h2>
            <p className="text-lg text-muted-foreground">
                Літосфера — це верхня тверда оболонка Землі. Вона не цілісна, а розбита на величезні блоки — <span className="text-yellow-500 font-bold">літосферні плити</span>.
            </p>
            <div className="bg-popover p-6 rounded-2xl border border-border">
                ...
                <ul className="grid grid-cols-2 gap-3 text-sm text-muted-foreground">
                    <li className="flex items-center gap-2"><div className="w-2 h-2 bg-yellow-500 rounded-full"></div> Євразійська</li>
                    <li className="flex items-center gap-2"><div className="w-2 h-2 bg-yellow-500 rounded-full"></div> Африканська</li>
                    <li className="flex items-center gap-2"><div className="w-2 h-2 bg-yellow-500 rounded-full"></div> Північноамериканська</li>
                    <li className="flex items-center gap-2"><div className="w-2 h-2 bg-yellow-500 rounded-full"></div> Тихоокеанська</li>
                    <li className="flex items-center gap-2"><div className="w-2 h-2 bg-yellow-500 rounded-full"></div> Індо-Австралійська</li>
                    <li className="flex items-center gap-2"><div className="w-2 h-2 bg-yellow-500 rounded-full"></div> Антарктична</li>
                </ul>
            </div>
        </div>
        <div className="flex-1">
             <div className="relative w-full aspect-video bg-popover rounded-2xl overflow-hidden border border-border shadow-2xl group">
                ...
                <svg className="absolute inset-0 w-full h-full opacity-60">
                    <path d="M 200 100 Q 300 150 400 100 T 600 200" fill="none" stroke="#eab308" strokeWidth="2" strokeDasharray="5,5" className="animate-pulse-slow" />
                    <path d="M 100 300 Q 250 250 400 350" fill="none" stroke="#eab308" strokeWidth="2" strokeDasharray="5,5" className="animate-pulse-slow" />
                </svg>
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-popover/60 px-4 py-2 rounded-xl backdrop-blur-md text-center">
                    ...
                    <p className="text-xs text-muted-foreground">Вони плавають на в'язкій мантії</p>
                </div>
             </div>
        </div>
    </div>
...
const PangeaPuzzle = () => {
    ...
    return (
        <div className="flex flex-col items-center h-full animate-in fade-in">
             <h2 className="text-3xl font-bold mb-4 text-foreground">Машина Часу: Збери Пангєю</h2>
             <p className="text-muted-foreground mb-8 max-w-xl text-center">
                ...
                Натисни кнопку, щоб запустити процес дрейфу материків у зворотному напрямку.
             </p>
             ...
             <div className="relative w-full max-w-2xl h-[400px] bg-sky-900/30 rounded-3xl border border-border overflow-hidden flex items-center justify-center">
                 ...
                 {!assembled && (
                     <>
                        <div className="absolute top-10 left-10 w-32 h-24 bg-stone-600 rounded-lg opacity-80 transition-all duration-1000 rotate-12 flex items-center justify-center text-xs font-bold">Пн. Америка</div>
                        <div className="absolute top-10 right-20 w-40 h-32 bg-stone-500 rounded-lg opacity-80 transition-all duration-1000 -rotate-6 flex items-center justify-center text-xs font-bold">Євразія</div>
                        <div className="absolute bottom-20 left-20 w-24 h-40 bg-stone-600 rounded-lg opacity-80 transition-all duration-1000 rotate-0 flex items-center justify-center text-xs font-bold">Пд. Америка</div>
                        <div className="absolute bottom-20 right-40 w-32 h-40 bg-stone-500 rounded-lg opacity-80 transition-all duration-1000 rotate-12 flex items-center justify-center text-xs font-bold">Африка</div>
                     </>
                 )}
                 ...
                 {assembled && (
                     <div className="relative animate-in zoom-in duration-1000">
                        ...
                        <div className="relative z-10 grid grid-cols-2 gap-1 p-4 bg-stone-800/50 rounded-3xl border-4 border-yellow-500/50">
                             <div className="w-24 h-24 bg-stone-600 rounded-lg flex items-center justify-center text-[10px] font-bold">Лавразія</div>
                             <div className="w-24 h-24 bg-stone-500 rounded-lg flex items-center justify-center text-[10px] font-bold">Гондвана</div>
                        </div>
                        <div className="absolute -bottom-10 left-1/2 -translate-x-1/2 text-yellow-500 font-bold text-xl drop-shadow-md">ПАНГЄЯ</div>
                     </div>
                 )}
             </div>
             ...
             {assembled && (
                 <div className="mt-4 flex items-center gap-2 text-green-400 animate-in slide-in-from-bottom">
                     ...
                     <span className="text-sm font-bold">AI: Абсолютно вірно! Материки ідеально пасують один до одного, як пазл.</span>
                 </div>
             )}
        </div>
    );
...
const TheoryPlateMovement = () => (
    <div className="flex flex-col items-center h-full animate-in fade-in">
        <h2 className="text-3xl font-bold mb-8 text-foreground">Танець Гігантів: Види Руху</h2>
        <div className="grid md:grid-cols-3 gap-6 w-full">
            ...
            <div className="bg-popover p-6 rounded-2xl border border-border hover:border-blue-500 transition-colors group">
                ...
                <p className="text-sm text-muted-foreground mb-4">Плити рухаються в різні боки. Утворюються розломи та нові океани.</p>
                <div className="text-xs font-mono text-blue-400 bg-blue-500/10 p-2 rounded">Приклад: Серединно-Атлантичний хребет</div>
            </div>
            ...
            <div className="bg-popover p-6 rounded-2xl border border-border hover:border-red-500 transition-colors group">
                ...
                <h3 className="text-xl font-bold text-foreground mb-2">Зіткнення (Субдукція)</h3>
                <p className="text-sm text-muted-foreground mb-4">Одна плита "пірнає" під іншу. Утворюються гори та вулкани.</p>
                <div className="text-xs font-mono text-red-400 bg-red-500/10 p-2 rounded">Приклад: Гімалаї, Анди</div>
            </div>
            ...
            <div className="bg-popover p-6 rounded-2xl border border-border hover:border-yellow-500 transition-colors group">
                ...
                <p className="text-sm text-muted-foreground mb-4">Плити труться одна об одну боками. Викликають сильні землетруси.</p>
                <div className="text-xs font-mono text-yellow-400 bg-yellow-500/10 p-2 rounded">Приклад: Розлом Сан-Андреас</div>
            </div>
        </div>
    </div>
);
...
const InteractivePlateMovement = () => {
    const [mode, setMode] = useState<'convergent' | 'divergent' | 'transform' | null>(null);

    return (
        <div className="flex flex-col h-full animate-in fade-in">
             <div className="flex justify-between items-end mb-6">
                <div>
                    <h2 className="text-2xl font-bold text-foreground mb-2">Лабораторія: "Що станеться, якщо...?"</h2>
                    <p className="text-muted-foreground text-sm">Обери тип руху і спостерігай за народженням рельєфу.</p>
                </div>
                <div className="flex gap-2">
                    <button onClick={() => setMode('divergent')} className={`px-3 py-2 rounded-lg border text-sm font-bold transition-all ${mode === 'divergent' ? 'bg-blue-500 text-foreground border-blue-500' : 'border-border hover:bg-popover'}`}>Розходження</button>
                    <button onClick={() => setMode('convergent')} className={`px-3 py-2 rounded-lg border text-sm font-bold transition-all ${mode === 'convergent' ? 'bg-red-500 text-foreground border-red-500' : 'border-border hover:bg-popover'}`}>Зіткнення</button>
                    <button onClick={() => setMode('transform')} className={`px-3 py-2 rounded-lg border text-sm font-bold transition-all ${mode === 'transform' ? 'bg-yellow-500 text-background border-yellow-500' : 'border-border hover:bg-popover'}`}>Ковзання</button>
                </div>
             </div>
             ...
             <div className="flex-1 bg-gradient-to-b from-sky-900/40 to-popover rounded-2xl border border-border relative overflow-hidden flex flex-col justify-end">
                 ...
                 <div className="relative w-full h-1/2 flex items-end justify-center">
                     ...
                     {/* Left Plate */}
                     <div className={`w-[45%] h-32 bg-stone-700 border-r-2 border-stone-800 transition-all duration-1000 relative z-10
                        ${mode === 'divergent' ? '-translate-x-12' : ''}
                        ${mode === 'convergent' ? 'translate-x-8' : ''}
                     `}>
                        <div className="absolute top-0 left-0 w-full h-4 bg-green-800/50"></div> {/* Grass */}
                     </div>

                     {/* Right Plate */}
                     <div className={`w-[45%] h-32 bg-stone-600 border-l-2 border-stone-800 transition-all duration-1000 relative z-10
                        ${mode === 'divergent' ? 'translate-x-12' : ''}
                        ${mode === 'convergent' ? '-translate-x-8' : ''}
                     `}>
             ...
             {mode && (
                 <div className="mt-4 p-4 bg-popover rounded-xl border border-border animate-in slide-in-from-bottom">
                     {mode === 'divergent' && <p className="text-muted-foreground">Плити розходяться. Магма піднімається, застигає і утворює нову земну кору (рифтові зони).</p>}
                     {mode === 'convergent' && <p className="text-muted-foreground">Зіткнення! Одна плита насувається на іншу. Земна кора зминається в складки, утворюючи гори.</p>}
                     {mode === 'transform' && <p className="text-muted-foreground">Ковзання. Плити чіпляються нерівностями. Напруга зростає, поки не станеться різкий ривок — землетрус.</p>}
                 </div>
             )}
        </div>
    );
...
const EarthquakeSimulation = () => {
    ...
    return (
        <div className="flex flex-col items-center h-full animate-in fade-in max-w-2xl mx-auto">
             <h2 className="text-3xl font-bold mb-8 text-foreground">Симулятор Землетрусу</h2>
             
             <div className={`w-full aspect-video bg-popover rounded-2xl border-2 relative overflow-hidden flex items-center justify-center transition-all duration-100
                ${isQuaking ? 'border-red-500 animate-[pulse_0.1s_ease-in-out_infinite]' : 'border-border'}
             `}>
                 {/* City Skyline */}
                 <div className={`flex items-end gap-1 transition-transform duration-100 ${isQuaking ? 'translate-x-1 translate-y-1' : ''}`}>
                    <div className="w-12 h-24 bg-muted"></div>
                    <div className="w-16 h-40 bg-muted/80 relative overflow-hidden">
                        {/* Windows */}
                        <div className="grid grid-cols-2 gap-1 p-1">
                            {Array(8).fill(0).map((_, i) => <div key={i} className={`h-2 bg-yellow-100/20 ${isQuaking ? 'animate-pulse' : ''}`}></div>)}
                        </div>
                    </div>
                 ...
                 {isQuaking && (
                     <div className="absolute inset-0 flex items-center justify-center bg-red-500/20 z-10 backdrop-blur-[2px]">
                         <span className="text-6xl font-black text-red-500 animate-ping">MAGNITUDE {Math.ceil(tension / 10)}</span>
                     </div>
                 )}
             </div>
             ...
             <div className="w-full mt-8 p-6 bg-popover rounded-2xl border border-border">
                 <div className="flex justify-between mb-2">
                     ...
                     <span className={`font-mono font-bold ${tension > 80 ? 'text-red-500' : 'text-yellow-500'}`}>{tension}%</span>
                 </div>
                 <input 
                    type="range" 
                    min="0" 
                 ...
                 />
                 <p className="text-xs text-muted-foreground mt-2">Перетягни повзунок вправо, щоб збільшити напругу між плитами.</p>
...
const RiskZonesMap = () => {
    ...
    const zones = [
        { id: 'ring', name: 'Тихоокеанське вогняне коло', desc: 'Тут відбувається 90% всіх землетрусів на Землі. Оточує Тихий океан.', top: '40%', left: '80%', color: 'bg-red-500' },
        { id: 'med', name: 'Середземноморський пояс', desc: 'Тягнеться від Європи до Азії. Зіткнення Африки та Євразії.', top: '35%', left: '55%', color: 'bg-orange-500' },
        { id: 'mid', name: 'Атлантичний хребет', desc: 'Місце народження нової кори на дні океану.', top: '50%', left: '42%', color: 'bg-yellow-500' },
    ];

    return (
        <div className="flex flex-col h-full animate-in fade-in">
             <h2 className="text-2xl font-bold mb-4 text-center text-foreground">Зони Сейсмічного Ризику</h2>
             <p className="text-muted-foreground text-center mb-8">Натисни на маркери, щоб дізнатися про найнебезпечніші місця планети.</p>
                ...
                {selectedZone && (
                    <div className="absolute bottom-6 left-6 right-6 md:left-auto md:right-6 md:w-80 bg-popover/90 backdrop-blur-md p-6 rounded-xl border border-border animate-in slide-in-from-bottom">
                         <div className="flex justify-between items-start mb-2">
                            <h3 className="font-bold text-foreground text-lg">{zones.find(z => z.id === selectedZone)?.name}</h3>
                            <button onClick={() => setSelectedZone(null)} className="text-muted-foreground hover:text-foreground"><CheckCircle2 size={16}/></button>
                         </div>
                         <p className="text-muted-foreground text-sm">{zones.find(z => z.id === selectedZone)?.desc}</p>
                    </div>
                )}
             </div>
        </div>
...
const PracticeSection = () => {
    ...
    const questions = [
        { title: "Гімалаї ростуть...", opts: ["Бо плити розходяться", "Бо Індія тисне на Євразію", "Через вітер"], ans: 1 },
        { title: "Що таке епіцентр?", opts: ["Точка під землею", "Точка на поверхні над вогнищем", "Сила землетрусу"], ans: 1 },
        { title: "Яка плита найбільша?", opts: ["Тихоокеанська", "Африканська", "Карибська"], ans: 0 },
        { title: "Прилад для вимірювання?", opts: ["Барометр", "Сейсмограф", "Термометр"], ans: 1 },
        { title: "Цунамі виникає через...", opts: ["Вітер", "Підводний землетрус", "Припливи"], ans: 1 },
    ];
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full animate-in fade-in max-w-lg mx-auto">
            <h2 className="text-2xl font-bold mb-8 text-foreground">Бліц-Опитування</h2>
            <div className="w-full bg-popover p-8 rounded-2xl border border-border relative overflow-hidden">
                <div className="text-muted-foreground text-sm mb-4">Питання {q + 1}</div>
                <h3 className="text-xl font-bold text-foreground mb-6 min-h-[60px]">{questions[q].title}</h3>
                ...
                {feedback !== null && (
                    <div className={`absolute inset-0 flex items-center justify-center backdrop-blur-sm bg-popover/50 transition-all ${feedback ? 'text-green-500' : 'text-red-500'}`}>
                        <div className="text-4xl font-bold animate-bounce">{feedback ? "Правильно!" : "Помилка!"}</div>
                    </div>
                )}
            </div>
        </div>
...
const MiniProjectSection = () => (
    <div className="flex flex-col items-center h-full animate-in fade-in max-w-2xl mx-auto">
        ...
        <h2 className="text-3xl font-bold mb-4 text-foreground">Проєкт: Сейсмолог-Дослідник</h2>
        ...
        <div className="w-full bg-popover p-6 rounded-2xl border border-border">
            <input type="text" placeholder="Назва та рік події" className="w-full bg-muted border border-border rounded-lg p-3 text-foreground mb-4 outline-none focus:border-yellow-500" />
            <textarea placeholder="Опис причин (які плити? який тип руху?)" className="w-full h-32 bg-muted border border-border rounded-lg p-3 text-foreground outline-none focus:border-yellow-500"></textarea>
...
const FinalTestSection = () => (
    <div className="flex flex-col items-center justify-center h-full text-center animate-in fade-in">
        ...
        <p className="text-muted-foreground max-w-md mb-8">
            Ти знаєш, як рухається планета. Тепер доведи це! 
            10 запитань про плити, вулкани та безпеку.
        </p>
...
const ReflectionSection = () => (
    <div className="flex flex-col items-center justify-center h-full animate-in fade-in max-w-2xl mx-auto">
        ...
        <div className="space-y-6 w-full">
            <div>
                <p className="text-muted-foreground mb-2 font-bold">Чи боїшся ти тепер землетрусів?</p>
                 <input type="range" className="w-full h-2 bg-muted rounded-lg appearance-none cursor-pointer accent-yellow-500" />
            ...
            <div className="bg-yellow-500/10 p-6 rounded-xl border border-yellow-500/20 flex gap-4">
                ...
                <p className="text-sm text-muted-foreground italic">
                    "Знання — це найкращий захист. Тепер ти розумієш природу цих явищ і знаєш, що робити."
                </p>
            </div>
        </div>
    </div>
    ...
    <div className="h-full flex flex-col animate-in fade-in">
        ...
        <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-popover p-6 rounded-2xl border border-border hover:border-green-500 transition-colors group">
                ...
                <p className="text-muted-foreground text-sm mb-6">Знайди на карті України найбільш сейсмічно активні зони (підказка: Карпати).</p>
            ...
            <div className="bg-popover p-6 rounded-2xl border border-border hover:border-blue-500 transition-colors group relative overflow-hidden">
                ...
                <p className="text-muted-foreground text-sm mb-6">Склади "Тривожну валізку": список з 10 речей, необхідних при землетрусі.</p>
            ...
            <div className="bg-popover p-6 rounded-2xl border border-border hover:border-purple-500 transition-colors group">
                ...
                <p className="text-muted-foreground text-sm mb-6">Напиши есе: "Як виглядатиме карта світу через 50 мільйонів років?".</p>
