            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                return (
                  <div
                    key={idx}
                    className="relative bg-muted/40 p-6 rounded-2xl border border-border/50 backdrop-blur-sm hover:shadow-lg hover:border-purple-500/30 transition-all group animate-in fade-in slide-in-from-bottom-8"
